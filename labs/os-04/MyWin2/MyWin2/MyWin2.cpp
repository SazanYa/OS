...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	TextOut(hdc, 100, 100, str1, 9);
	TextOut(hdc, 100, 110, str1, 9);
	TextOut(hdc, 100, 120, str1, 9);
	TextOut(hdc, 100, 130, str1, 9);
	TextOut(hdc, 100, 140, str1, 9);
...
LRESULT CALLBACK myF(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
		...
		{
			int z = MessageBoxEx(NULL, TEXT("HELLO"), TEXT("DialogWin"), MB_OK, 0x0459);
